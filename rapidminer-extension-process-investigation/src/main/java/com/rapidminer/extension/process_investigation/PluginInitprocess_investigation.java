/*
 * Martin Schmitz for RapidMiner GmbH
 * 
 * Copyright (C) 2018-2018 by Martin Schmitz for RapidMiner GmbH and the contributors
 * 
 ...
 */
package com.rapidminer.extension.process_investigation;
 ...
 * @author REPLACEME
 */
public final class PluginInitprocess_investigation {

		private PluginInitprocess_investigation() {
